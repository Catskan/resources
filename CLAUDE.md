...
- `Microsoft-Resources/` — standalone PowerShell + Azure Logic Apps + ADO pipelines. Reference material. Note: `Enable_winrm.ps1` previously lived here too — it now lives in `Ansible/roles/windows_gaming/files/bootstrap_winrm.ps1` as the source of truth.
